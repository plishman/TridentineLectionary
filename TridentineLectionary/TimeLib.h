...
//typedef void  (*setExternalTime)(const time64_t); // not used in this version


/*==============================================================================*/
/* Useful Constants */
#define SECS_PER_MIN  ((time64_t)(60UL))
#define SECS_PER_HOUR ((time64_t)(3600UL))
#define SECS_PER_DAY  ((time64_t)(SECS_PER_HOUR * 24UL))
#define DAYS_PER_WEEK ((time64_t)(7UL))
#define SECS_PER_WEEK ((time64_t)(SECS_PER_DAY * DAYS_PER_WEEK))
#define SECS_PER_YEAR ((time64_t)(SECS_PER_WEEK * 52UL))
#define SECS_YR_2000  ((time64_t)(946684800UL)) // the time at the start of y2k
...
time64_t now();              // return the current time as seconds since Jan 1 1970 
...
void breakTime(time64_t time, tmElements_t &tm);  // break time64_t into elements
time64_t makeTime(tmElements_t &tm);  // convert time elements into time64_t
